...
// generated by "schematyper --package=types config/v3_1_experimental/schema/ignition.json -o config/v3_1_experimental/types/schema.go --root-type=Config" -- DO NOT EDIT
