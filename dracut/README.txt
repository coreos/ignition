...
# for Fedora (classic)
    ...
    rm /etc/machine-id
    add 'ip=dhcp rd.neednet=1 enforcing=0 ignition.firstboot' to /boot/grub2/grub.cfg

# for Fedora Atomic Host
    rpm-ostree initramfs --enable
    rpm-ostree ex kargs --append 'ip=dhcp rd.neednet=1 enforcing=0 ignition.firstboot'
