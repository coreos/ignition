...
import (
	...
	fcos1_7 "github.com/coreos/ignition/v2/butane/config/fcos/v1_7"
	fcos1_8_exp "github.com/coreos/ignition/v2/butane/config/fcos/v1_8_exp"
	...
	openshift4_21 "github.com/coreos/ignition/v2/butane/config/openshift/v4_21"
	openshift4_22 "github.com/coreos/ignition/v2/butane/config/openshift/v4_22"
...
func init() {
	...
	RegisterTranslator("openshift", "4.22.0", openshift4_22.ToConfigBytes)
	RegisterTranslator("openshift", "4.23.0-experimental", openshift4_23_exp.ToConfigBytes)
