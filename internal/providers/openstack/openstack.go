...
func fetchConfigFromMetadataService(f *resource.Fetcher) ([]byte, error) {
	...
	if ipv4Err == nil {
		...
		metadataServiceUrlIPv6.Host = fmt.Sprintf("fe80::a9fe:a9fe%%25%s", interfaceName)
		metadataServiceUrlIPv6Str := fmt.Sprintf("http://[%s]/openstack/latest/user_data", metadataServiceUrlIPv6.Host)
